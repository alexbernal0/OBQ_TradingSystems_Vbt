# ============================================================================
# FIXED PERCENTAGE STOP LOSS - RSI Entry Template
# ============================================================================
...
# ============================================================================
# EXIT LOGIC - FIXED PERCENTAGE STOP LOSS
# ============================================================================
...
print(f"\n{'='*60}")
print(f"FIXED PERCENTAGE STOP LOSS - {SYMBOL}")
print(f"{'='*60}\n")
...
fig.update_layout(
    title=f"Fixed {STOP_LOSS_PCT*100:.0f}% Stop Loss - {SYMBOL}",
    xaxis_title="Date",
