# ============================================================================
# FIXED ACCOUNT PERCENTAGE STOP LOSS - RSI Entry Template
# ============================================================================
# Stop loss based on fixed percentage of account equity
...
ACCOUNT_RISK_PCT = 0.02  # 2% of account
...
# ============================================================================
# EXIT LOGIC - FIXED ACCOUNT PERCENTAGE STOP LOSS
# ============================================================================
...
for i in range(len(df)):
    if long_entries[i] and not in_long and not in_short:
        ...
        # Stop loss based on fixed percentage of account equity
        # STOP LOGIC: # Calculate position size based on account risk
...
print(f"\n{'='*60}")
print(f"FIXED ACCOUNT PERCENTAGE STOP LOSS - {SYMBOL}")
print(f"{'='*60}\n")
