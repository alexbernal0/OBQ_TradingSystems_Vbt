# ============================================================================
# FIXED ATR STOP LOSS - RSI Entry Template
# ============================================================================
# Stop loss based on fixed ATR multiplier from entry
...
# ============================================================================
# EXIT LOGIC - FIXED ATR STOP LOSS
# ============================================================================
...
print(f"\n{'='*60}")
print(f"FIXED ATR STOP LOSS - {SYMBOL}")
print(f"{'='*60}\n")
