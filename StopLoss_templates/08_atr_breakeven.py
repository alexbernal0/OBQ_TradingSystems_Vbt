# ============================================================================
# ATR BREAKEVEN STOP - RSI Entry Template
# ============================================================================
# ATR stop that moves to breakeven when target hit
...
for i in range(len(df)):
    if long_entries[i] and not in_long and not in_short:
        ...
        # ATR stop that moves to breakeven when target hit
        # STOP LOGIC: # Initial stop at ATR distance
stop_distance = atr[i] * ATR_STOP_MULT
stop_price = entry_price - sto...
...
print(f"\n{'='*60}")
print(f"ATR BREAKEVEN STOP - {SYMBOL}")
print(f"{'='*60}\n")
