# ============================================================================
# PERCENTAGE BREAKEVEN STOP - RSI Entry Template
# ============================================================================
# Percentage stop that moves to breakeven at target
...
# ============================================================================
# EXIT LOGIC - PERCENTAGE BREAKEVEN STOP
# ============================================================================
...
print(f"\n{'='*60}")
print(f"PERCENTAGE BREAKEVEN STOP - {SYMBOL}")
print(f"{'='*60}\n")
