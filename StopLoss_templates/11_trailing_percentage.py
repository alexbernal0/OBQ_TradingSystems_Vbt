# ============================================================================
# TRAILING PERCENTAGE STOP - RSI Entry Template
# ============================================================================
# Trailing stop at fixed percentage from peak
...
# ============================================================================
# EXIT LOGIC - TRAILING PERCENTAGE STOP
# ============================================================================
...
for i in range(len(df)):
    if long_entries[i] and not in_long and not in_short:
        ...
        # Trailing stop at fixed percentage from peak
        # STOP LOGIC: # Trail stop at percentage from peak
if is_long:
...
print(f"\n{'='*60}")
print(f"TRAILING PERCENTAGE STOP - {SYMBOL}")
print(f"{'='*60}\n")
