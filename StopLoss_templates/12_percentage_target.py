# ============================================================================
# PERCENTAGE PROFIT TARGET - RSI Entry Template
# ============================================================================
# Exit at fixed percentage profit target
...
# ============================================================================
# EXIT LOGIC - PERCENTAGE PROFIT TARGET
# ============================================================================
...
for i in range(len(df)):
    if long_entries[i] and not in_long and not in_short:
        ...
        # Exit at fixed percentage profit target
        # STOP LOGIC: # Target price
target_price = entry_price * (1 + TARGET_PCT) if is_long else entry_price * (1 - TARG...
...
print(f"\n{'='*60}")
print(f"PERCENTAGE PROFIT TARGET - {SYMBOL}")
print(f"{'='*60}\n")
