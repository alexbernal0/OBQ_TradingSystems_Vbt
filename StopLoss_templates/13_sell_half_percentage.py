# ============================================================================
# SELL HALF AT PERCENTAGE TARGET - RSI Entry Template
# ============================================================================
# Sell half position at percentage target, hold rest
...
# ============================================================================
# EXIT LOGIC - SELL HALF AT PERCENTAGE TARGET
# ============================================================================
# Sell half position at percentage target, hold rest
...
print(f"\n{'='*60}")
print(f"SELL HALF AT PERCENTAGE TARGET - {SYMBOL}")
print(f"{'='*60}\n")
...
fig.update_layout(
    title=f"SELL HALF AT PERCENTAGE TARGET - {SYMBOL}",
    xaxis_title="Date",
