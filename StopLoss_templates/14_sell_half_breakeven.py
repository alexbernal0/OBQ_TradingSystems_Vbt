# ============================================================================
# SELL HALF + BREAKEVEN STOP - RSI Entry Template
# ============================================================================
# Sell half at target, move stop to breakeven
...
# ============================================================================
# EXIT LOGIC - SELL HALF + BREAKEVEN STOP
# ============================================================================
# Sell half at target, move stop to breakeven
...
print(f"\n{'='*60}")
print(f"SELL HALF + BREAKEVEN STOP - {SYMBOL}")
print(f"{'='*60}\n")
...
fig.update_layout(
    title=f"SELL HALF + BREAKEVEN STOP - {SYMBOL}",
    xaxis_title="Date",
