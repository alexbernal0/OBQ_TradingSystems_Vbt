# ============================================================================
# ACCOUNT PERCENTAGE TARGET - RSI Entry Template
# ============================================================================
# Exit when profit reaches percentage of account
...
# ============================================================================
# EXIT LOGIC - ACCOUNT PERCENTAGE TARGET
# ============================================================================
# Exit when profit reaches percentage of account
...
print(f"\n{'='*60}")
print(f"ACCOUNT PERCENTAGE TARGET - {SYMBOL}")
print(f"{'='*60}\n")
...
fig.update_layout(
    title=f"ACCOUNT PERCENTAGE TARGET - {SYMBOL}",
    xaxis_title="Date",
