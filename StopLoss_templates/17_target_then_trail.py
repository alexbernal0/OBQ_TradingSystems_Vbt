# ============================================================================
# TARGET THEN TRAIL - RSI Entry Template
# ============================================================================
# Hit target, then switch to trailing stop
...
print(f"\n{'='*60}")
print(f"TARGET THEN TRAIL - {SYMBOL}")
print(f"{'='*60}\n")
...
fig.update_layout(
    title=f"TARGET THEN TRAIL - {SYMBOL}",
    xaxis_title="Date",
