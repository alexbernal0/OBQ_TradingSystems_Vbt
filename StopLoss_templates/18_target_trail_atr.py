# ============================================================================
# ATR TARGET + ATR TRAIL - RSI Entry Template
# ============================================================================
# ATR-based target with ATR trailing stop
...
# ============================================================================
# EXIT LOGIC - ATR TARGET + ATR TRAIL
# ============================================================================
# ATR-based target with ATR trailing stop
...
print(f"\n{'='*60}")
print(f"ATR TARGET + ATR TRAIL - {SYMBOL}")
print(f"{'='*60}\n")
...
fig.update_layout(
    title=f"ATR TARGET + ATR TRAIL - {SYMBOL}",
    xaxis_title="Date",
