# ============================================================================
# SWING HIGH/LOW STOP - RSI Entry Template
# ============================================================================
# Stop based on swing highs and lows
...
# ============================================================================
# EXIT LOGIC - SWING HIGH/LOW STOP
# ============================================================================
# Stop based on swing highs and lows
...
print(f"\n{'='*60}")
print(f"SWING HIGH/LOW STOP - {SYMBOL}")
print(f"{'='*60}\n")
...
fig.update_layout(
    title=f"SWING HIGH/LOW STOP - {SYMBOL}",
    xaxis_title="Date",
