# ============================================================================
# CHANDELIER STOP - RSI Entry Template
# ============================================================================
# ATR-based volatility stop (Chandelier)
...
print(f"\n{'='*60}")
print(f"CHANDELIER STOP - {SYMBOL}")
print(f"{'='*60}\n")
...
fig.update_layout(
    title=f"CHANDELIER STOP - {SYMBOL}",
    xaxis_title="Date",
