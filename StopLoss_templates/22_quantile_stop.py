# ============================================================================
# QUANTILE DYNAMIC STOP - RSI Entry Template
# ============================================================================
# Quantile-based dynamic stop loss
...
# ============================================================================
# EXIT LOGIC - QUANTILE DYNAMIC STOP
# ============================================================================
# Quantile-based dynamic stop loss
...
print(f"\n{'='*60}")
print(f"QUANTILE DYNAMIC STOP - {SYMBOL}")
print(f"{'='*60}\n")
...
fig.update_layout(
    title=f"QUANTILE DYNAMIC STOP - {SYMBOL}",
    xaxis_title="Date",
